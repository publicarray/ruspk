...
export default function Login({ errorMessage, setErrorMessage, onSubmit, processing }) {
    ...
    async function resetPassword (event) {
        ...
        const response = await postJsonForm(`${API}/newreset`, event, []);
    ...
    return (
        ...
        <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
            ...
            <div className="py-5">
                ...
                <div className="text-center sm:text-left whitespace-nowrap">
                    <button onClick={openModal} className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
        ...
        <Model
            ...
            buttons={<Button className="" type="submit">Reset</Button>}
