...
export default function Nav() {
    return (
        ...
        <Link href="/">
            <a className="block text-gray-500 dark:text-gray-200 text-xl lg:text-2xl font-bold cursor-pointer"><span className="text-blue-600 dark:text-blue-400">Syno</span>Community</a>
        </Link>
