...
impl DbFirmware {
    ...
    pub fn create_firmware(conn: &Connection, vers_str: String, build: i32) -> QueryResult<DbFirmware> {
    ...
    pub fn delete_firmware(conn: &Connection, id: i32) -> QueryResult<usize> {
